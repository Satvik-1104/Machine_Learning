...
class MigrationAnalysisSystem:
    ...
    def _calculate_trend_models(self):
        """Calculate trend models for each combination of Measure, Country, and Citizenship"""
...
class MigrationAnalysisGUI:
    ...
    def create_plots_tab(self):
        # Create frames for different plot types
        self.prediction_plot_frame = ttk.LabelFrame(self.plots_tab, text="Prediction Analysis")
        self.prediction_plot_frame.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)

        self.trends_plot_frame = ttk.LabelFrame(self.plots_tab, text="Migration Trends")
    ...
    def update_plots(self, y_test, y_pred):
        ...
        for measure in yearly_measure['Measure'].unique():
            ...
            # Plot future predictions with dashed line
